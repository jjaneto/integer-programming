...
A principal diferença entre as formulações foi notada na quantidade linhas do problema a ser otimizado. Como esperado, \textsl{CLQ1} gerou menos linhas a serem otimizadas do que a formulação original (com restrições nas arestas).
